...
export const Button = ({
    ...
    const variants = {
        primary: "bg-primary text-white hover:bg-[#002d8a] focus:ring-primary shadow-md hover:shadow-lg",
        secondary: "bg-accent text-white hover:bg-[#e0a030] focus:ring-accent shadow-md hover:shadow-lg",
        outline: "border-2 border-primary text-primary bg-transparent hover:bg-blue-50 focus:ring-primary",
